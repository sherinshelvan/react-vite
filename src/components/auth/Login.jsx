...
const Login = () => {
  ...
  useEffect(() => {
    ...
    // link.rel = 'stylesheet';
    // link.href = '/src/assets/vendor/css/pages/page-auth.css';
        ...
        <div className="authentication-inner">
          ...
          <div className="card">
            <div className="card-body">
              ...
              <form id="formAuthentication" className="mb-3" onSubmit={handleLogin} method="POST">
                <div className="mb-3">
